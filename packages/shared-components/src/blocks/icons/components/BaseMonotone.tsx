    ...
    <IconWrapper
      ...
      icon={
        <svg
          ...
          {...props}
        >
            <g clipPath="url(#clip0_30855_6334)">
                <path
                ...
                />
                <g clipPath="url(#clip1_30855_6334)">
                    <path
                        d="M9.99032 15.5C13.0334 15.5 15.5 13.0378 15.5 10C15.5 6.96224 13.0334 4.5 9.99032 4.5C7.10348 4.5 4.7354 6.71672 4.5 9.53756H11.7824V10.4624H4.5C4.7354 13.2833 7.10348 15.5 9.99032 15.5Z"
